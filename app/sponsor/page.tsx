      ...
      <section className="mx-auto flex w-full max-w-desktop items-stretch py-xl">
        ...
        <div className="flex flex-1 flex-col items-center max-lg:px-sm">
          ...
          >
            ...
            <button
              type="submit"
              className="whitespace-nowrap rounded-lg bg-[rgb(var(--color-light-neutral-gray)/0.25)] px-lg py-sm text-button text-light-primary transition-all duration-100 ease-in-out hover:opacity-75"
            >
              Submit
            </button>
          </form>
